  ...
  const notifications = [
    {
      id: 1,
      title: "Game Result",
      message: "🎉 Congrats! You won ₹500 in the last quiz.",
      time: "Just now",
    },
    {
      id: 2,
      title: "Reminder",
      message: "Don’t forget to join today’s live quiz at 8PM!",
      time: "10 mins ago",
    },
  ];
    ...
    <div className="flex h-screen bg-[#1a001d] text-white">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <header className="flex items-center justify-between px-4 md:px-6 py-3 bg-[#2b0030] shadow-md">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg">
            <button
              className="md:hidden"
            ...
            <div className="relative">
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-[#2b0030] border border-gray-700 rounded-lg shadow-lg overflow-hidden z-50">
                  <div className="flex items-center gap-2 px-4 py-3 hover:bg-[#3d0045] cursor-pointer">
                    <img
                      src="https://i.pravatar.cc/40"
                      alt="user"
                    ...
                    />
                    <div>
                      <p className="text-sm font-semibold">User_123</p>
                      <span className="text-xs text-gray-400">View Profile</span>
                    </div>
                  </div>
                  <button className="w-full text-left px-4 py-2 hover:bg-[#3d0045] text-sm">
                    Log out
                  </button>
                </div>
              )}
        ...
        <div className="flex-1 flex items-center justify-center text-center p-4">
          <div className="max-w-xl">
            ...
            <button className="bg-white text-purple-700 font-semibold px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-md">
              🚀 Start Quiz Now
            </button>
          </div>
        </div>
      ...
      {showNotifications && (
        <div className="absolute right-2 left-2 sm:left-auto top-16 w-full sm:w-80 max-w-[90vw] bg-[#2b0030] border border-gray-700 rounded-xl shadow-lg p-4 z-50">
